...
<?= $this->section('isi'); ?>
<?= form_open('datapeminjamanbarang/updatedata') ?>
...
<div class="form-group-row">
    ...
    <div class="input-group mb-8 col-sm-6">
        <input type="text" class="form-control" placeholder="Input kode barang" name="kdbarang" id="kdbarang" value="<?= $kodebarang; ?>">
...
<div class="form-group-row">
    ...
    <div class="col-sm-6">
        <input type="text" class="form-control" id="letak" name="letak" value="<?= $letak; ?>">
    </div>
</div>
<div class="form-group-row">
